...
<!-- 111$n, 711$n 1.103 -->
    ...
    <originInfo>
      ...
      <xsl:variable name="MARCpublicationText" select="normalize-space(document($marc-countries-file)//countries:country[countries:code=$MARCpublicationCode]/countries:name/text())" />
